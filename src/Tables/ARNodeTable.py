...
class ARNodeTable(TableSupportsDeletion):
    ...
    def decide_list_of_best_arnodes_to_merge(self, function_to_decide_list_of_best_arnodes,
        ...
        a list of doubles,
        a list of currently chosen arnodes to merge
        ...
        the_stop_signal,
        a list of doubles,
        a list of chosen arnodes to merge
        ...
        for node in self.nodes:
            stop_signal, current_list_of_doubles, current_list_of_arnodes_to_merge = \
                function_to_decide_list_of_best_arnodes(node,
                                                        current_list_of_doubles,
                                                        current_list_of_arnodes_to_merge)
            if stop_signal:
                return stop_signal, current_list_of_doubles, current_list_of_arnodes_to_merge

        return stop_signal, current_list_of_doubles, current_list_of_arnodes_to_merge

    def decide_best_arnodes_to_split(self, function_to_decide_best_arnode_to_split,
                                     first_iteration_list_of_doubles,
                                     first_iteration_arnode_to_split,
                                     first_iteration_arnode_partition):
        """
        :param first_iteration_list_of_doubles:
        :param first_iteration_arnode_partition:
        :param first_iteration_arnode_to_split:
        ...
        the idea is that we will take turns giving this function each and every arnode in this table,
        and let it decide which arnode to split.
        ...
        stop_signal = False
        current_list_of_doubles = first_iteration_list_of_doubles
        currently_chosen_arnode_to_split = first_iteration_arnode_to_split
        current_arnode_partition = first_iteration_arnode_partition

        for node in self.nodes:
            stop_signal, current_list_of_doubles, currently_chosen_arnode_to_split, current_arnode_partition = \
                function_to_decide_best_arnode_to_split(node,
                                                        current_list_of_doubles,
                                                        currently_chosen_arnode_to_split,
                                                        current_arnode_partition)
            if stop_signal:
                return stop_signal, current_list_of_doubles, currently_chosen_arnode_to_split, current_arnode_partition
